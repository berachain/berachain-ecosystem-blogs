...
When a heading comes after a paragraph, we need a bit more space, as I already mentioned above. Now let's see what a more complex list would look like.
...
I almost forgot to mention links, like [this link to the Tailwind CSS website](https://tailwindcss.com). We almost made them blue but that's so yesterday, so we went with dark gray, which feels edgier.
